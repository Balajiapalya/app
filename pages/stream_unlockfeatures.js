        ...
        <div className={`${styles.container} ${styles.newstream}`} >
            <div className={styles.body}>
                <div className={styles.model_nav}>
                    <a onClick={()=>closestream(false)} className={styles.model_close} role="button"><img src="close.png" alt="close"/> </a>
                ...
                <div className={styles.main}>
                    ...
                    <div className={styles.select}>
                        ...
                        <button type="text" className={styles.up}><img src="updown.png" alt="close"></img></button>
                    </div>
