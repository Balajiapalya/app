...
import Videoditor from "./recordingvideoclips_tabs/videoeditor";
import Using_api from "./recordingvideoclips_tabs/using_api";

export default function Recordingvideoclips_tabs(props){
                        ...
                        <div className={styles1.wrapper_tabs}>
                            <div className={styles1.bloc_tabs}>
                                <button
                                    ...
                                    onClick={() => toggleTab(1)}
                                >
                                    <span className={styles1.tab}>Use Video Editor</span>
                                </button>
                                <button
                                    className={toggleState === 2 ? `${styles1.tabs_item} ${styles1.active_tabs}` : `${styles1.tabs_item}`}
                                    onClick={() => toggleTab(2)}
                                >
                                    <span className={styles1.api_center}>Use APIs</span>
                                </button>
                            </div>
