            ...
            <div className={styles.containercomponents}>
                ...
                <div className={styles.uppercomponents}>
                    <ul>
                        ...
                        <li>
                            <Link href='/Live_stream'><a className={router.pathname=='/Live_stream' ? `${styles.activate}` :''}><img src={router.pathname=='/Live_stream' ? '/images/live-streaming.svg' : '/images/live-streaming(inactive).svg'} alt='icon'></img><span>Live Stream</span></a></Link>
                        </li>
                        <li>
                            <Link href='/Live_recording'><a className={router.pathname=='/Live_recording' ? `${styles.activate}` :''}><img src={router.pathname=='/Live_recording' ? '/images/icon-liverecording.svg' : '/images/live-recording(inactive).svg'} alt='icon'></img><span>Live Recording</span></a></Link>
                        </li>
