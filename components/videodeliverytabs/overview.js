                                    ...
                                    <div className={styles.link_embedcode}>
                                        ...
                                        <div className={styles.copy_link}>
                                            <div className={styles.link}>
                                                ...
                                                <p>{'<iframe width="560" height="315" src="http://http://13.235.3.29/videos/embed" allowfullscreen ></iframe>'} </p>

                                            </div>
                                            <div className={styles.copy_img}>
                                                <CopyToClipboard text='<iframe width="560" height="315" src="http://http://13.235.3.29/videos/embed" allowfullscreen ></iframe>'>
                                                    <img src='/images/iconionic-ios-copy.png' alt='copy' />
                                                </CopyToClipboard>
                                            </div>
                                        </div>
