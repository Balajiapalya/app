                                    ...
                                    <tr key={items.id}>
                                        ...
                                        <td>
                                            <form onSubmit={handleSubmit(onSubmit)}>
                                                {closemodal && <div> 
                                                    {items.name}
                                                    <a  ><img onClick={() => {setopeninvitemember(true),setclosemodal(false)} } src='Images/Icon material-edit.png' /></a><br />
                                                ...
                                                {openModel && <div>
                                                    ...
                                                    />
                                                    {errors.title && <p className={'validations'}>This field is required</p>}
                                                    ...
                                                    <div className={styles.dev_options}>
                                                        <a onClick={() => {setopeninvitemember(false),setclosemodal(true)}}  className={styles.dev_Cancel}>Cancel</a>
                                                        <button type='submit' className={styles.dev_save}>Save</button>
                                                    </div>
                                                </div>}
                                            </form>
